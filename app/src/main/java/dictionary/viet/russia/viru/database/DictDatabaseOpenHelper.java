...
import dictionary.viet.russia.viru.BuildConfig;
import dictionary.viet.russia.viru.NextDictUtils.CLog;

/**
 * Created by manhi on 17/3/2016.
 */
public class DictDatabaseOpenHelper {
    // tên file datebase trong thư mục assets
    private Context context;

    public DictDatabaseOpenHelper(Context context) {
    ...
    private void copy(String path, String DB_NAME) throws IOException {
        ...
        InputStream is = context.getAssets().open("dict/" + DB_NAME);
